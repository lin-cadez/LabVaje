...
setup:				//v Z damo naslov byta, kjer se zaène niz znakov
...
nov_znak:	
		lpm r16, Z+	//Z poveèamo za 1, ker bomo 

		cpi r16, 0	//preverimo, èe smo na koncu null terminated niza; èe smo gremo vn
		breq vrni_se

		call u16_bit_mnozi_z_10

		//èe je zadeva ascii cifra rabimo samo spodnje 4 bite
		andi r16, 0x0F

		//vrednost prištejemo rezultatu
		add XL, r16

		//èe ni prenosa, preskoèino naslednjo instrukcijo
		brcc ni_prenosa
		inc XH
...
u16_bit_mnozi_z_10:
		...
		push r1		//visoki del rezultata zaèasno damo na stran, ker se ga bo rabilo za prištevanje naprej
